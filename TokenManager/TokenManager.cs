    ...
    public partial class TokenManager : Form
    {
        ...
        public async Task RefreshProfiles(List<String> profiles,bool launchWhenAllRefreshed)
        {
            foreach (var profile in profiles)
            {
                ...
                {
                    DisableButtons();
                    Task<bool> task = Task.Factory.StartNew(() => MH.SetupWithBrowser(profile.Trim(' ')));
                    var result = await task;
                    EnableButtons();
                }
                catch (Exception e)
        ...
        //no ref
        private void dumpRegKeyButton_Click_1(object sender, EventArgs e)
        {

        }
        private void configureAccountsButton_Click_1(object sender, EventArgs e)
        {
        ...
        private void saveAccounInfo_CheckedChanged(object sender, EventArgs e)
        {
