...
namespace TokenManager
{
    public partial class AccountConfiguration : Form
    {
        ...
        private void windowYposition_TextChanged(object sender, EventArgs e)
        {
        ...
        private void windowXposition_TextChanged(object sender, EventArgs e)
        {

        }

        private void gameLaunchArgs_TextChanged(object sender, EventArgs e)
        {

        }

        private void postLaunchCmd_TextChanged(object sender, EventArgs e)
        {

        }

        private void preLaunchCmd_TextChanged(object sender, EventArgs e)
        {
        ...
        private void grabWindowXYButton_Click_1(object sender, EventArgs e)
        {
        ...
        private void separateJsonSettings_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void muteWhenMinimized_CheckedChanged(object sender, EventArgs e)
        {
